...
__  |/ /__  __ \    ___  __/__________________ _______  _____  __    __  ___/______  /____  _________ 
__    /__  / / /    __  /  _  _ \_  ___/_  __ `__ \  / / /_  |/_/    _____ \_  _ \  __/  / / /__  __ \
_    | _  /_/ /     _  /   /  __/  /   _  / / / / / /_/ /__>  <      ____/ //  __/ /_ / /_/ /__  /_/ /
/_/|_| /_____/      /_/    \___//_/    /_/ /_/ /_/\__,_/ /_/|_|      /____/ \___/\__/ \__,_/ _  .___/ 
                                                                                             /_/                                                                     
                                                                                                                                                                                                                            
CREATED BY XD JIBON MAHMUD
''')
def slowprint(s):
    for c in s + '\n' :
        sys.stdout.write(c)
...
+--------------------------------------+
| Coded By XD4RK W4RR10R|version : 3.0  |
+--------------------------------------+''')
...
def slowprint(s):
    for c in s + '\n' :
        ...
        time.sleep(8. / 100)
print("\033[95m+-------------------------------------------------+")
slowprint('''\033[95m|             Welcome To XD4RK W4RR10R           |
